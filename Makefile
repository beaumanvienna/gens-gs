...
DIST_COMMON = $(srcdir)/git_version.am $(srcdir)/Makefile.in \
	$(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(srcdir)/config.h.in mkinstalldirs \
...
XMKMF = 
YASM = 
abs_builddir = /home/yo/gens-gs
abs_srcdir = /home/yo/gens-gs
