...
// Numeric Keypad
#define GENS_KEY_NUM_0		SDLK_KP_0
#define GENS_KEY_NUM_1		SDLK_KP_1
#define GENS_KEY_NUM_2		SDLK_KP_2
#define GENS_KEY_NUM_3		SDLK_KP_3
#define GENS_KEY_NUM_4		SDLK_KP_4
#define GENS_KEY_NUM_5		SDLK_KP_5
#define GENS_KEY_NUM_6		SDLK_KP_6
#define GENS_KEY_NUM_7		SDLK_KP_7
#define GENS_KEY_NUM_8		SDLK_KP_8
#define GENS_KEY_NUM_9		SDLK_KP_9
...
#define GENS_KEY_NUM_EQUALS	SDLK_KP_EQUALS
...
#define GENS_KEY_NUMLOCK	SDLK_NUMLOCKCLEAR
#define GENS_KEY_CAPSLOCK	SDLK_CAPSLOCK
#define GENS_KEY_SCROLLLOCK	SDLK_SCROLLLOCK
...
#define GENS_KEY_LMETA		SDLK_LGUI
#define GENS_KEY_RMETA		SDLK_RGUI
#define GENS_KEY_LSUPER		SDLK_LGUI
#define GENS_KEY_RSUPER		SDLK_RGUI
#define GENS_KEY_MODE		SDLK_MODE
#define GENS_KEY_COMPOSE	SDLK_APPLICATION

// Miscellaneous function keys
#define GENS_KEY_HELP		SDLK_HELP
#define GENS_KEY_PRINT		SDLK_PRINTSCREEN
#define GENS_KEY_SYSREQ		SDLK_SYSREQ
#define GENS_KEY_BREAK		SDLK_PAUSE
